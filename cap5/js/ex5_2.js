...
function apostarNumero() {
  ...
  if (numero == sorteado) {
    ...
    if (erros.indexOf(numero) >= 0) {
      ...
      var numChances = CHANCES - numErros; // calcula n de chances
      // exibe n de erros, conteúdo do cvetor e n de chances
  ...
  // Limpa campo de entrada e posiciona cursos neste campo
  inNumero.value = "";
  inNumero.focus();
}
